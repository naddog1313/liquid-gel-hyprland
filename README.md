...
Compositor: hyprland
UI Components: waybar, walker, swww (for wallpapers)
Terminal: alacritty
note: THIS IS AN ARCH SETUP
Browser Google chrome or firefox or zen you can edit the bindings
Optional nwg-dock and nwg-drawer

# Clone the repository
git clone https://github.com/naddog1313/liquid-gel-hyprland
cd liquid-gel-hyprland

# Back up your current config
mv ~/.config/hypr ~/.config/hypr_backup

# Copy the dotfiles
cp -r All config folder for example cp -r hypr ~/.config
